 ...
 * 继承{@link BaseMvpActivity}
 * <p>
 * 1.三段式布局 头部  内容区域  导航栏
 * 2.头部 导航栏 默认为空. 通过方法 {@link #buildTitleBar()}{@link #buildNavigationBar()}} 添加不同的View
 ...
 */
public abstract class BaseMvpListActivity<Data extends BaseItem, V extends BaseView, P extends BasePresenter<V>>
    ...
    private void initRefresh() {
        mRefreshLayout.setOnRefreshLoadMoreListener(new OnRefreshLoadMoreListener() {
            ...
            public void onRefresh(final com.scwang.smartrefresh.layout.api.RefreshLayout refreshlayout) {
                //刷新
//              BaseMvpListActivity.this.hideLoading();//刷新隐藏loading
                pageIndex = 1;
            ...
            public void onLoadMore(final com.scwang.smartrefresh.layout.api.RefreshLayout refreshlayout) {
                //加载
//              BaseMvpListActivity.this.hideLoading();//加载隐藏loading
                pageIndex++;
                startRequest(pageIndex, pageSize);
            }
        });
    ...
    private void initRecycler() {
        mRecyclerView.setLayoutManager(mManager = new GridLayoutManager(this, mColumnCount = buildColumnCount()));
    ...
    private void checkNextPage(List<Data> datas) {
        if (nextPage(datas)) {
