 ...
 * @竖屏播放控制
 */
public class PlayerVerticalControlView
    ...
    UIPlayerVerticalManage mUIManage;
    ...
    public PlayerVerticalControlView(Context context) {
        super(context);
    }

    public PlayerVerticalControlView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PlayerVerticalControlView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onCreate(Context context) {
        ...
        mUIManage = new UIPlayerVerticalManage(context, this);
