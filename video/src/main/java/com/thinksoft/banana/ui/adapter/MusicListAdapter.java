 ...
 * @
 */
public class MusicListAdapter extends BaseCompleteRecyclerAdapter<CircleItem> {
    public MusicListAdapter(Context context) {
        super(context);
    }

    public MusicListAdapter(Context context, OnAppListener.OnAdapterListener listener) {
    ...
    protected void setItemLayout() {
        ...
        addItemLayout(Constant.TYPE_ITEM_2, R.layout.item_music_list_content);
        ...
        protected void onBindBaseViewHoder(BaseViewHoder holder, int position, final ScreenBean item) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    MusicListAdapter.this.getListener().onInteractionAdapter(Constant.TYPE_ITEM_3, null);
                }
            });
        }
    };
