 ...
 * @
 */
public class UIPlayerCircleManage {
    Context context;
    ...
    public UIPlayerCircleManage(Context context, BaseViewGroup view) {
        this.context = context;
        mGestureControl = (PlayerGestureControlView) view;

        View.inflate(context, R.layout.view_player_circle_control, view);
        ...
        view.setOnClick(R.id.backButton, R.id.playerButton, R.id.qpIconButton);
    }
