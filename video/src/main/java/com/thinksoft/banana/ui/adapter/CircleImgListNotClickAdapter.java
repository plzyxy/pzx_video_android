 ...
 * @
 */
public class CircleImgListNotClickAdapter extends BaseCompleteRecyclerAdapter<CircleItem> {
    public CircleImgListNotClickAdapter(Context context) {
        super(context);
    }

    public CircleImgListNotClickAdapter(Context context, OnAppListener.OnAdapterListener listener) {
