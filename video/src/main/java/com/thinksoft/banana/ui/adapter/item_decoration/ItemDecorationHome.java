...
public class ItemDecorationHome extends RecyclerView.ItemDecoration {
     ...
     */
    public ItemDecorationHome(int spanCount, Rect mEdge, int spacing, Integer... itemType) {
     ...
     * @param edge      左右边距
     */
    public ItemDecorationHome(int spanCount, int spacing, int top, int edge, Integer... itemType) {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (mItemType.contains(itemType) || mItemType == null) {
